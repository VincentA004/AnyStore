...
const hasAmplifyConfig = Boolean(
  process.env.NEXT_PUBLIC_USER_POOL_ID && process.env.NEXT_PUBLIC_USER_POOL_CLIENT_ID
);

// Local system font stack — no network font fetches at build or runtime.
